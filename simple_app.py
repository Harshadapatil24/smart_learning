        ...
        {% if 'username' not in session %}
            <div class="login-form">
                ...
                <div style="text-align: center; margin-top: 15px;">
                    <p>Don't have an account? <a href="/register" style="color: var(--primary-color); text-decoration: none;">Register here</a></p>
                </div>
            </div>
        {% else %}
            ...
            <div class="dashboard">
                <div class="card">
                    ...
                    <img src="/static/images/math-icon.svg" alt="Math" class="subject-icon" style="width: 60px; height: 60px; object-fit: contain;">
                    <h3>Math Learning</h3>
                ...
                <div class="card">
                    ...
                    <img src="/static/images/science-icon.svg" alt="Science" class="subject-icon" style="width: 60px; height: 60px; object-fit: contain;">
                ...
                <div class="card">
                    ...
                    <img src="/static/images/programming-icon.svg" alt="Programming" class="subject-icon" style="width: 60px; height: 60px; object-fit: contain;">
                    <h3>Programming</h3>
                ...
                <div class="card">
                    ...
                    <img src="/static/images/language-icon.svg" alt="Language" class="subject-icon" style="width: 60px; height: 60px; object-fit: contain;">
                    <h3>Language Arts</h3>
...
def register():
    if request.method == 'POST':
        ...
        if not username or not password or not email or not name:
            return render_template_string(registration_template, error='All fields are required')
        
        # Check if username already exists
        if username in users:
            return render_template_string(registration_template, error='Username already exists')
